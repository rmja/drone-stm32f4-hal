...
pub mod config {
    ...
    uart_setup!(Uart8, PClk1);

    #[cfg(any(stm32_mcu = "stm32f413",))]
    uart_setup!(Uart9, PClk2);

    #[cfg(any(stm32_mcu = "stm32f413",))]
    uart_setup!(Uart10, PClk2);
