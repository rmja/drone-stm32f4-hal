...
impl HseClk {
    ...
    pub const fn f(&self) -> u32 { self.0 }
}
...
impl HsiClk {
    pub const fn f(&self) -> u32 { 16_000_000 }
}
...
impl PllSrc {
    ...
    pub const fn f(&self) -> u32 { self.mux.f() / self.m }
...
impl PllVco {
    ...
    pub const fn f(&self) -> u32 { self.src.f() * self.n }
}
...
impl<Out> PllClk<Out> {
    pub const fn f(&self) -> u32 { self.src.f() / self.div }
}
...
impl SysClk {
    ...
    pub const fn f(&self) -> u32 { self.mux.f() }
...
impl HClk {
    pub const fn f(&self) -> u32 { self.src.f() / self.hpre }
...
impl PClk1 {
    ...
    pub const fn f(&self) -> u32 { self.src.f() / self.ppre1 }
}
...
impl PClk2 {
    ...
    pub const fn f(&self) -> u32 { self.src.f() / self.ppre2 }
}
