...
pub use self::pin::{
    AlternateMode, GpioPin, GpioPinSpeed, OutputMode, PinAf0, PinAf1, PinAf10, PinAf11, PinAf12,
    PinAf13, PinAf14, PinAf15, PinAf2, PinAf3, PinAf4, PinAf5, PinAf6, PinAf7, PinAf8, PinAf9,
    PinAfToken, PinModeToken, PinPullToken, PinTypeToken,
};
...
pub mod prelude {
    pub use crate::pin::{
        ...
        PinAf6, PinAf7, PinAf8, PinAf9, PinAfToken, PinModeToken, PinPullToken, PinTypeToken,
